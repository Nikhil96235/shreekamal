...
**25 August 2026:**
- **Hero images ab COMPLETE dikhti hain (koi cut nahi)** — saari hero images 16:9 (1376x768) hain, par `.hero-slides` pe `max-height:620px` cap tha jisse bade screen pe container 16:9 se chaura ho jaata tha aur cover upar-neeche crop karta tha. `max-height:620px` hataya → container hamesha `height:56.25vw` (16:9), images perfectly fit, bina cut/bars. (Bade screen pe hero thoda taller.) *(25 Aug)*
